    ...
    <Card className="shadow-lg animate-fade-in">
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className="bg-white p-4 rounded-md shadow-sm flex flex-col items-center justify-center text-center">
            <BookOpen className="h-6 w-6 text-corporate-gold mb-2" />
            <div className="text-sm text-gray-600">Words Mastered</div>
            <div className="text-2xl font-bold text-corporate-navy mt-1">
        ...
        <div className="bg-white p-4 rounded-md shadow-sm">
          <div className="flex justify-between items-center mb-2">
            <h3 className="font-semibold text-corporate-navy">Current Mastery Level</h3>
