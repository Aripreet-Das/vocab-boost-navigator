    ...
    <Card className="shadow-lg animate-fade-in progress-stats-card">
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div className={`${isDark ? 'bg-corporate-darkgray' : 'bg-gray-100'} p-4 rounded-md shadow-sm flex flex-col items-center justify-center text-center`}>
        ...
        <div className={`${isDark ? 'bg-corporate-darkgray' : 'bg-gray-100'} p-4 rounded-md shadow-sm`}>
