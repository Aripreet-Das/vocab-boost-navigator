    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-6xl lg:max-w-7xl">
        <div className="mb-8 text-center">
          ...
          <p className={`text-lg ${isDark ? 'text-gray-200' : 'text-gray-700'} max-w-4xl mx-auto leading-relaxed`}>
            Welcome to <span className="font-bold">CorVoMaster</span>, where we believe <span className="font-bold text-corporate-navy dark:text-corporate-gold">synergy</span> <span className="italic text-gray-600 dark:text-gray-300">(combined effort resulting in a greater outcome)</span> is the secret sauce behind professional growth. Our platform is here to be your <span className="font-bold text-corporate-navy dark:text-corporate-gold">game-changer</span> <span className="italic text-gray-600 dark:text-gray-300">(something that significantly alters the way things are done)</span> in mastering corporate communication. We blend daily learning, practical examples, and interactive features to help you sharpen your <span className="font-bold text-corporate-navy dark:text-corporate-gold">competitive edge</span> <span className="italic text-gray-600 dark:text-gray-300">(an advantage that sets you apart)</span> and elevate your career.
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div className={`p-6 rounded-lg ${isDark ? 'bg-corporate-darkgray' : 'bg-gray-50'} border ${isDark ? 'border-corporate-navy' : 'border-gray-200'} shadow-sm`}>
              ...
              <p className={`${isDark ? 'text-gray-200' : 'text-gray-600'} leading-relaxed`}>
                Kick off each morning with a fresh business term, complete with its definition, usage examples, and fun tidbits to make learning both effective and enjoyable. Start building your <span className="font-bold text-corporate-navy dark:text-corporate-gold">ROI</span> <span className="italic text-gray-600 dark:text-gray-300">(Return on Investment)</span> in professional vocabulary one word at a time.
              </p>
            </div>
            ...
            <div className={`p-6 rounded-lg ${isDark ? 'bg-corporate-darkgray' : 'bg-gray-50'} border ${isDark ? 'border-corporate-navy' : 'border-gray-200'} shadow-sm`}>
              ...
              <ul className={`list-disc pl-5 ${isDark ? 'text-gray-200' : 'text-gray-600'} space-y-2 leading-relaxed`}>
                ...
                <li><span className="font-semibold">Financial Fluency</span>: Learn the language of finance to discuss <span className="font-bold text-corporate-navy dark:text-corporate-gold">cash flow</span> <span className="italic text-gray-600 dark:text-gray-300">(movement of money in and out of a business)</span>, budgets, and investments like a pro.</li>
                <li><span className="font-semibold">Marketing Mastery</span>: Dive into strategic terms to craft a standout <span className="font-bold text-corporate-navy dark:text-corporate-gold">value proposition</span> <span className="italic text-gray-600 dark:text-gray-300">(the promise of value to be delivered)</span> for any brand.</li>
                <li><span className="font-semibold">Negotiation Know-How</span>: Master the art of deal-making by learning to leverage your <span className="font-bold text-corporate-navy dark:text-corporate-gold">BATNA</span> <span className="italic text-gray-600 dark:text-gray-300">(Best Alternative to a Negotiated Agreement)</span> and close high-stakes discussions confidently.</li>
              </ul>
            </div>
            ...
            <div className={`p-6 rounded-lg ${isDark ? 'bg-corporate-darkgray' : 'bg-gray-50'} border ${isDark ? 'border-corporate-navy' : 'border-gray-200'} shadow-sm`}>
              ...
              <p className={`${isDark ? 'text-gray-200' : 'text-gray-600'} leading-relaxed`}>
                Discover how words like <span className="font-bold text-corporate-navy dark:text-corporate-gold">paradigm shift</span> <span className="italic text-gray-600 dark:text-gray-300">(fundamental change in approach or assumptions)</span> or <span className="font-bold text-corporate-navy dark:text-corporate-gold">stakeholders</span> <span className="italic text-gray-600 dark:text-gray-300">(people or groups with an interest in an organization's success)</span> come to life in real-world business scenarios. From brainstorming sessions to quarterly reviews, we help you see—and use—these terms where they matter most.
              </p>
            </div>
            ...
            <div className={`p-6 rounded-lg ${isDark ? 'bg-corporate-darkgray' : 'bg-gray-50'} border ${isDark ? 'border-corporate-navy' : 'border-gray-200'} shadow-sm`}>
              ...
              <p className={`${isDark ? 'text-gray-200' : 'text-gray-600'} leading-relaxed`}>
                Track your milestones with our intuitive dashboard. Whether it's your daily streak, modules completed, or words mastered, we'll show you just how close you are to becoming a <span className="font-bold text-corporate-navy dark:text-corporate-gold">powerhouse communicator</span> <span className="italic text-gray-600 dark:text-gray-300">(someone with exceptionally strong communication skills)</span>.
              </p>
            </div>
